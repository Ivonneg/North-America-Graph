...
\node[circle, draw, color=red] (Mch) at (0,4){39};
...
\node[circle, draw, color=green] (ON) at (7,16){63};
...
\node[circle, draw, color=green] (TN) at (5,11){81};
...
\node[circle, draw, color=red] (Ver) at (6,6){85};
